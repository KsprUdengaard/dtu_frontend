...
def show():
	...
	data_limit = 1000
	historical_config_tab =  [
		{"header": "Average humidity [%]", "parameter": "mean_relative_hum", "y_axis_label": "Humidity [%]", "plot_type": "line"},
    	{"header": "Average temperature [°C]", "parameter": "mean_temp", "y_axis_label": "Temperature [°C]", "plot_type": "line"},
    	{"header": "Average wind speed [m/s]", "parameter": "mean_wind_speed", "y_axis_label": "Wind speed [m/s]", "plot_type": "line"},
    	{"header": "Average pressure [hPa]", "parameter": "mean_pressure", "y_axis_label": "Pressure [hPa]", "plot_type": "line"},
    	{"header": "Average radiation [W/m²]", "parameter": "mean_radiation", "y_axis_label": "Radiation [W/m²]", "plot_type": "line"},
    	{"header": "Accumulated precipitation [mm]", "parameter": "acc_precip", "y_axis_label": "Precipitation [mm]", "plot_type": "bar"},
    	{"header": "Average cloud cover [%]", "parameter": "mean_cloud_cover", "y_axis_label": "Cloud cover [%]", "plot_type": "line"}
    ]
	...
	if st.button('Request Data'):
		for i, config in enumerate(historical_config_tab):
			payload={
			...
			container = DataContainer(weather_url, payload, apiFetcher, historicalProcessor) 
